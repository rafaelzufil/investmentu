            ...
            'blog_posting'         => array(
                ...
                'fields' => array(
                    ...
                    'datePublished'    => array(
                        ...
                        'type'     => 'text',
                        'class'    => 'kcseo-date',
                        'desc'     => __('Like this: 2015-12-25 4:00 PM', "wp-seo-structured-data-schema-pro"),
                        'required' => true
                    ),
                    'dateModified'     => array(
            ...
            'course'               => array(
                ...
                'fields' => array(
                    ...
                    'validFrom'            => array(
                        ...
                        'type'  => 'text',
                        'class' => 'kcseo-date',
                        'desc'  => __('The date when the item becomes valid. Like this: 2015-12-25 4:00 PM', "wp-seo-structured-data-schema-pro")
                    ),
                    'performerType'        => array(
            ...
            'event'                => array(
                ...
                'fields' => array(
                    ...
                    'startDate'            => array(
                        ...
                        'class'    => 'kcseo-date',
                        'required' => true,
                        'desc'     => __("Event start date, Like this: 2015-12-25 4:00 PM", "wp-seo-structured-data-schema-pro")
                    ),
                    'endDate'              => array(
                        'title'       => __('End date', "wp-seo-structured-data-schema-pro"),
                        'type'        => 'text',
                        'recommended' => true,
                        'class'       => 'kcseo-date',
                        'desc'        => __("Event end date, Like this: 2015-12-25 4:00 PM", "wp-seo-structured-data-schema-pro")
                    ),
                    'description'          => array(
                        'title'       => __('Description', "wp-seo-structured-data-schema-pro"),
                        'type'        => 'textarea',
                    ...
                    'validFrom'            => array(
                        ...
                        'recommended' => true,
                        'class'       => 'kcseo-date',
                        'desc'        => __(sprintf("The date and time when tickets go on sale (only required on date-restricted offers), in <a href='%s' target='_blank'>ISO-8601 format</a> Like this: 2015-12-25 4:00 PM", 'https://en.wikipedia.org/wiki/ISO_8601'), "wp-seo-structured-data-schema-pro")
                    ),
                    'url'                  => array(
                        'title'       => 'URL',
                        'recommended' => true,
            ...
            'product'              => array(
                ...
                'fields' => array(
                    ...
                    'priceValidUntil'    => array(
                        ...
                        'recommended' => true,
                        'class'       => 'kcseo-date',
                        'desc'        => __("The date (in ISO 8601 date format) after which the price will no longer be available. Like this: 2015-12-25 4:00 PM", "wp-seo-structured-data-schema-pro")
                    ),
                    'availability'       => array(
                        'title'   => 'Availability',
                        'type'    => 'select',
