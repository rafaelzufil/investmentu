	...
	protected function render_header() {
		...
		<div class="sui-header">
			...
			<div class="sui-actions-right">
				<?php if ( 'wphb-minification' === $this->slug && apply_filters( 'wp_hummingbird_is_active_module_minify', false ) ) : ?>
					<a class="sui-button sui-button-ghost" data-a11y-dialog-show="wphb-minification-tour">
	...
	public function render() {
		...
		<div class="sui-wrap<?php echo $settings['accessible_colors'] ? ' sui-color-accessible ' : ' '; ?>wrap-wp-hummingbird wrap-wp-hummingbird-page <?php echo 'wrap-' . esc_attr( $this->slug ); ?>">
			...
			if ( WP_Hummingbird::get_instance()->admin->show_quick_setup ) :
				Utils::get_modal( 'quick-setup' );
				Utils::get_modal( 'check-performance' );
				?>
				<script>
