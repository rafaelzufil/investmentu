...
use Hummingbird\Core\Modules\Smush;
...
class Dashboard extends Page {
	...
	private function init() {
		$this->gzip_status    = Utils::get_status( 'gzip' );
		$this->caching_status = Utils::get_status( 'caching' );
	...
	public function on_load() {
		if ( is_multisite() && ! is_network_admin() && Utils::can_execute_php() ) {
	...
	public function render_header() {
		...
		<div class="sui-header">
			...
			<div class="sui-actions-right">
				...
				<?php } ?>
				<?php if ( ! Utils::hide_wpmudev_doc_link() ) : ?>
	...
	public function register_meta_boxes() {
		...
		/* Smush */
		if ( is_main_site() || is_network_admin() || ( is_multisite() && Smush::is_enabled() && ! get_site_option( 'wp-smush-networkwide' ) ) ) {
			...
			if ( ! Smush::is_installed() || ! Smush::is_enabled() || ! Smush::can_be_configured() ) {
				$smush_footer = null;
			}
	...
	public function dashboard_welcome_metabox_header() {
		...
		$title = sprintf( __( 'Welcome %s', 'wphb' ), Utils::get_current_user_info() );
	...
	public function dashboard_browser_caching_module_metabox() {
		$caching_status = $this->caching_status;
		$recommended    = Utils::get_recommended_caching_values();
		$expiration     = 0;
		...
		$args = array(
			...
			'caching_type_tooltips' => Utils::get_browser_caching_types(),
	...
	public function dashboard_smush_metabox() {
		...
		$this->view(
			...
			array(
				...
				'is_active'        => Smush::is_enabled(),
				'is_installed'     => Smush::is_installed(),
				'smush_data'       => $smush_data,
				'is_pro'           => Smush::$is_smush_pro,
