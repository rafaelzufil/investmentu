...
class AJAX {
	...
	public function __construct() {
		...
		// Parse preload cache click from admin bar.
		add_action( 'wp_ajax_wphb_preload_cache', array( $this, 'preload_cache' ) );
	...
	/**
	 * Handle preload cache button click in admin bar.
	 *
	 * @since 2.1.0
	 */
	...
	public function page_cache_save_settings() {
		...
		$options['preload_interval'] = isset( $data['preload'] ) && isset( $data['preload']['interval'] ) ? $data['preload']['interval'] : $defaults['page_cache']['preload_interval'];
