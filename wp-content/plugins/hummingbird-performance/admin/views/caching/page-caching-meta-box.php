	...
	<div class="sui-box-settings-col-2">
		<div class="sui-form-field sui-no-margin-bottom">
			...
			<span class="sui-description sui-toggle-description">
				<?php esc_html_e( 'Preloading will happen in the background, you don\'t need to do anything other than turn it on. Note: large website may take some time to complete.', 'wphb' ); ?>
			</span>
		</div>

		<div class="<?php echo $options['preload'] ? '' : 'sui-hidden'; ?>" id="preload_interval">
			<div class="sui-border-frame sui-toggle-content">
				<div class="sui-form-field sui-no-margin-bottom">
					<label class="sui-label" for="preload-interval">
						<?php esc_html_e( 'Preload post interval', 'wphb' ); ?>
					</label>
					<input type="text" class="sui-form-control sui-input-sm sui-field-has-suffix" name="preload[interval]" id="preload-interval" value="<?php echo absint( $options['preload_interval'] ); ?>" />
					<span class="sui-field-suffix"><?php esc_html_e( 'ms', 'wphb' ); ?></span>
				</div>
				<span class="sui-description">
					<?php esc_html_e( 'The recommended time for posts interval is 500ms, but you can change it as needed.', 'wphb' ); ?>
				</span>
			</div>
		</div>
	</div>
...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		<div class="sui-form-field">
			<label class="sui-toggle">
				<input type="checkbox" class="toggle-checkbox" name="settings[compress]" value="1" id="compress" <?php checked( $settings['settings']['compress'] ); ?>>
				<span class="sui-toggle-slider"></span>
			</label>
...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		<div class="sui-form-field">
			<?php $cookies = join( PHP_EOL, $settings['exclude']['cookies'] ); ?>
