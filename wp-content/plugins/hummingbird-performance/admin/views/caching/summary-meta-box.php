...
<div class="sui-summary-segment">
	<div class="sui-summary-details">
		...
		<span class="sui-summary-detail">
			...
			<?php else : ?>
				<?php esc_html_e( 'Preloaded', 'wphb' ); ?>
				<span class="sui-tooltip sui-tooltip-constrained" data-tooltip="<?php esc_html_e( 'Preload caching finished. It will automatically start preloading in the background when you publish or update a post/page.', 'wphb' ); ?>">
					<i class="sui-icon-info" aria-hidden="true"></i>
				</span>
			<?php endif; ?>
		</span>
