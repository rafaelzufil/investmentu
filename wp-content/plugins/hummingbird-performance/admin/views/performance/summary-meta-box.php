...
<div class="sui-summary-segment">
	<div class="sui-summary-details">
		<?php if ( $last_report && ! is_wp_error( $last_report ) && ! $report_dismissed ) : ?>
			...
			<i class="sui-icon-<?php echo esc_attr( \Hummingbird\Core\Modules\Performance::get_impact_class( $last_report->{$type}->score, 'icon' ) ); ?> sui-md sui-<?php echo esc_attr( \Hummingbird\Core\Modules\Performance::get_impact_class( $last_report->{$type}->score ) ); ?>"></i>
		...
		<li>
			...
			<span class="sui-list-detail">
				<?php if ( is_wp_error( $last_report ) ) : ?>
					-
				<?php else : ?>
					<span class="sui-tag sui-tag-<?php echo esc_attr( \Hummingbird\Core\Modules\Performance::get_audits_class( $last_report->{$type}->audits->opportunities ) ); ?>">
