...
\Hummingbird\Core\Utils::get_modal( 'reset-settings' );
?>

<form method="post" class="settings-frm">
	<p>
		<?php esc_html_e( 'Control what to do with your settings and data. Settings are each module’s configuration options, Data includes the stored information like cached pages, statistics other pieces of information stored over time.', 'wphb' ); ?>
	</p>
	...
	<div class="sui-box-settings-row">
		...
		<div class="sui-box-settings-col-2">
			<a href="#" class="sui-button sui-button-ghost sui-button-icon-left" data-a11y-dialog-show="wphb-reset-settings-modal">
