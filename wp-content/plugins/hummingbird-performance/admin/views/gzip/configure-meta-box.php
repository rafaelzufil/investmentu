...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		<?php
		\Hummingbird\Core\Utils::get_servers_dropdown(
			array(
...
<div class="sui-box-settings-row">
	...
	<?php if ( ! ( $htaccess_written && $full_enabled ) ) : ?>
		<div id="wphb-server-instructions-apache" class="wphb-server-instructions" data-server="apache" style="display: none;">
			<div class="sui-tabs">
				<div data-tabs>
					<div class="active"><?php esc_html_e( 'Automatic', 'wphb' ); ?></div>
				...
				<div data-panes>
					<div class="active">
						...
						<?php if ( true === $htaccess_writable ) : ?>
							<div id="enable-cache-wrap" class="<?php echo 'apache' !== $gzip_server_type ? 'hidden' : ''; ?>">
								<?php if ( $show_enable_button ) : ?>
									...
									<?php else : ?>
										...
										<?php endif; ?>
										<a href="<?php echo esc_url( $enable_link ); ?>" class="sui-button sui-button-blue sui-margin-top"><?php esc_html_e( 'Apply Rules', 'wphb' ); ?></a>
									<?php endif; ?>
								<?php endif; ?>
							</div>
						<?php endif; ?>
					...
					<div class="apache-instructions">
						...
						<p><?php \Hummingbird\Core\Utils::still_having_trouble_link(); ?></p>
					</div>
				</div>
			</div>
