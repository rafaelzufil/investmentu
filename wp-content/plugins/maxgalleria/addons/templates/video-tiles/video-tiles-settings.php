...
<!--			<tr style="display:none;">
			...
			<tr>
				<td colspan="2" class="options-heading"><?php _e('GALLERY STYLES', 'maxgalleria') ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
				  <table class="mg-settings">
						<tr>
							<td class="mg-radio">
								<input data-default="<?php echo $options->thumb_columns_default ?>"  id="thickness_default" type="radio" name="<?php echo $options->ns_border_thickness_default_key ?>" value="1" class="border-thickness" <?php echo ($options->get_border_thickness_default() === '1') ? 'checked' : ''; ?>>
							</td>
							<td class="mg-radio">
			...
			<tr>
				...
				<td>
				  <table class="mg-settings">
						<tr>
							<td class="mg-radio">
								<input data-default="<?php echo $options->ns_shadow_spread_default ?>"  id="spread-default" type="radio" name="<?php echo $options->ns_shadow_spread_default_key ?>" value="0" class="ns-blur-type" <?php echo ($options->get_shadow_spread_default() === '0') ? 'checked' : ''; ?>>
							</td>
							<td class="mg-radio">
								<input type="radio" name="<?php echo $options->ns_shadow_spread_default_key ?>" value="1" class="ns-blur-type" <?php echo ($options->get_shadow_spread_default() === '1') ? 'checked' : ''; ?>>
							</td>
							<td class="mg-radio">
								<input type="radio" name="<?php echo $options->ns_shadow_spread_default_key ?>" value="2" class="ns-blur-type" <?php echo ($options->get_shadow_spread_default() === '2') ? 'checked' : ''; ?>>
							</td>
							<td class="mg-radio">
								<input type="radio" name="<?php echo $options->ns_shadow_spread_default_key ?>" value="3" class="ns-blur-type" <?php echo ($options->get_shadow_spread_default() === '3') ? 'checked' : ''; ?>>
							</td>
						</tr>
						<tr>
							<td>
			...
			<tr>
				<td colspan="2" class="options-heading"><?php _e('THUMBNAIL OPTIONS', 'maxgalleria') ?></td>
			</tr>
			<tr>
      ...
      <tr>
			...
			<tr>
				<td colspan="2" class="options-heading"><?php _e('LIGHTBOX SETTINGS', 'maxgalleria') ?></td>
			</tr>
      <tr>
			...
			<tr>
				...
				<td>
					<table id="close-table">
						<tr>
							<td class="mg-radio">
								<input type="radio" name="<?php echo $options->ns_lightbox_close_default_key ?>" value="0" class="close-button" <?php echo ($options->get_lightbox_close_default() === '0') ? 'checked' : ''; ?>>
							</td>
							<td class="mg-radio">
			...
			<tr>
				...
				<td>
					<table id="arrow-table">
						<tr>
							<td class="mg-radio">
								<input type="radio" name="<?php echo $options->ns_lightbox_arrow_default_key ?>" value="0" class="close-button" <?php echo ($options->get_lightbox_arrow_default() === '0') ? 'checked' : ''; ?>>
							</td>
							<td class="mg-radio">
      ...
      <?php if(class_exists('Responsive_Lightbox')) { ?>
        <tr>
          <td><?php _e('Use dFactory Responsive Lightbox:<br>(Set "Thumbnail Click Opens" to "Video URL" when using this option.)', 'maxgalleria') ?></td>
          <td>
      ...
      <tr>
			...
			<tr><td colspan="2" class="options-heading"><span class="mg-heading"><?php _e('GALLERY OPTIONS', 'maxgalleria') ?></span></td></tr>
      <tr>
				<td class="padding-top"><?php _e('Gallery Enabled (Displays previous and next navigation arrows):', 'maxgalleria') ?></td>
				<td class="padding-top">
			...
			<tr>                
				<td><?php _e('Arrow Button Markup*:', 'maxgalleria') ?><br><span class="mg-italic"><?php _e("Please use only single quotes in markup text.", "maxgalleria") ?></span></td>
				<td>          
			...
			<tr><td colspan="2" class="options-heading"><span class="mg-heading"><?php _e('ADVANCED SETTINGS', 'maxgalleria') ?></span></td></tr>
  ...
  jQuery(document).ready(function() {
    ...
    jQuery("#<?php echo $options->counter_markup_default_key; ?>").keyup(function() {  
      ...
      jQuery(this).val(newTemp);
		...
		jQuery("#<?php echo $options->ns_shadow_default_key ?>").change(function() {
			var shadow_type = jQuery("#<?php echo $options->ns_shadow_default_key ?>").val();
