...
class MaxGalleriaSettings {
	...
	public function save_general_settings() {
        ...
        $rewrite_slug = trim(stripslashes(strip_tags($_POST[MAXGALLERIA_SETTING_REWRITE_SLUG])));				
			...
			if (isset($_POST[MAXGALLERIA_SETTING_SHOW_ADDON_PAGE]) && $_POST[MAXGALLERIA_SETTING_SHOW_ADDON_PAGE] != '') {
				update_option(MAXGALLERIA_SETTING_SHOW_ADDON_PAGE, $_POST[MAXGALLERIA_SETTING_SHOW_ADDON_PAGE]);
			}
			else {
