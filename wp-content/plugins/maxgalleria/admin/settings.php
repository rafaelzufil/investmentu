	...
	<div class="wrap">
		...
		<div class="mg-settings">
			<div class="main">
              ...
              <li class="<?php echo 'maxgalleria-watermark' == $addon ? 'selected' : '' ?>">
                <a href="<?php echo MAXGALLERIA_SETTINGS . '&addon=maxgalleria-watermark' ?>">Watermark</a>
              </li>
							<?php } ?>
...
<!--								<div class="settings-title">
									<?php _e('Get Addons Page', 'maxgalleria') ?>
								</div>
								<div class="settings-options">
									<p>
										<label for="<?php echo MAXGALLERIA_SETTING_SHOW_ADDON_PAGE ?>"><?php _e('Hide the Get Addons Page:', 'maxgalleria') ?></label>
										<input type="checkbox" style="margin-left: 10px;" id="<?php echo MAXGALLERIA_SETTING_SHOW_ADDON_PAGE ?>" name="<?php echo MAXGALLERIA_SETTING_SHOW_ADDON_PAGE ?>" <?php echo (($maxgalleria->settings->get_show_addon_page() == 'on') ? 'checked' : '') ?> />
									</p>
								</div>-->
