...
function IU_recent_posts_shortcode($atts, $content = null) {
  ...
  if ( function_exists( 'is_amp_endpoint' ) && is_amp_endpoint() ) {
	 return '<div class="row my-2 row-eq-height category-article-preview-row">'. $output .'</div><a class="btn btn-block btn-primary form-control mx-auto" [href]="\'' . esc_url(home_url('/')) . 'category/'.  $category[0]->slug .'/\'" style="width:60%;" on="tap:AMP.navigateTo(url=\'' . esc_url(home_url('/')) . 'category/'.  $category[0]->slug .'\')">View More</a>';
  }
  else {
